...
export const classicalMusicComposer = (instance: ChatGPTAPI) => {
  ...
  return {
     ...
     * @returns {Promise<ChatMessage>} ChatGPT Message
     */    
    classicalMusicComposer: async (message: string): Promise<ChatMessage> => createPromptFactory(instance, prompt)(message),
  };
};
...
export const digitalArtGalleryGuide = (instance: ChatGPTAPI) => {
  ...
  return {
     ...
     * @returns {Promise<ChatMessage>} ChatGPT Message
     */    
    digitalArtGalleryGuide: async (message: string): Promise<ChatMessage> => createPromptFactory(instance, prompt)(message),
  };
};
...
export const publicSpeakingCoach = (instance: ChatGPTAPI) => {
  ...
  return {
     ...
     * @returns {Promise<ChatMessage>} ChatGPT Message
     */    
    publicSpeakingCoach: async (message: string): Promise<ChatMessage> => createPromptFactory(instance, prompt)(message),
  };
};
